...
(function($){
	$.fn.ShowKefu = function(options){
		$().Sonline({
			...
			Tel:"0760-23888060<br><span style='font-size:14px;'>（工作日9:00-17:00）</span>",//其它信息图片等
			Qqlist:"45276638|售前咨询,41195584|售前咨询,174416037|技术支持,45276638|建议/投诉" //多个QQ用','隔开，QQ和客服名用'|'隔开
