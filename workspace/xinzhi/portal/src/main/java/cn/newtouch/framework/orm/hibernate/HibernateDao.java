...
import cn.newtouch.framework.orm.JdbcUtils;
import cn.newtouch.framework.utils.ReflectionUtils;
...
public class HibernateDao<T, PK extends Serializable> {
	...
	@PostConstruct
	public void initAutoGenerator() {
		generator = new LocalAutoGenerator();
		generator.setSessionFactory(sessionFactory);
		generator.init(entityClass);
	...
	public T save(final T entity) {
		...
		if (generator.need()) {
			generator.generatorID(entity);
		}
		Serializable id = getSession().save(entity);
		logger.debug("save entity: {}", entity);
		return (T) getSession().load(entity.getClass(), id);
	}
