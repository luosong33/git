...
<div>
  ...
  <section class="order-content jm-grid-box-bg-white jm-grid-border-1px jm-grid-box-border-radius">
    <div class="order-map-wrapper">
      ...
      <div class="box">
        <div class="content orderChinaMapChart" ref='orderChinaMapChart'>
    ...
    <aside class="order-data-summary">
      <header>
        <ul class="clearfix">
          <li class="left" v-bind:class="{ 'is-active': currentSelectedPeriod === 'week' }"
           @click="selectPeriod('week')">
            本周
          </li>
          <li class="left" v-bind:class="{ 'is-active': currentSelectedPeriod === 'month' }"
            @click="selectPeriod('month')">
            本月
          </li>
          <li class="left " v-bind:class="{ 'is-active': currentSelectedPeriod === 'quarter' }" 
            @click="selectPeriod('quarter')">
            本季
          </li>
          <li class="left " v-bind:class="{ 'is-active': currentSelectedPeriod === 'year' }"
            ...
            <table class="jm-table">
              ...
              <tbody>
                <tr>
                  <td scope="row">1</td>
                  <td>南宁关区</td>
                  <td class="jm-text-align-right">4500</td>
                </tr>
                <tr>
                  <td scope="row">1</td>
                  <td>南宁关区</td>
            ...
            <table class="jm-table">
              ...
              <tbody>
                <tr>
                  <td scope="row">1</td>
                  <td>南宁关区</td>
                  <td class="jm-text-align">4500</td>
                </tr>
                <tr>
                  <td scope="row">1</td>
                  <td>南宁关区</td>
...
export default {
  ...
  mounted() {
    ...
    function loadorderChinaMapChart() {
