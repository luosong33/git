  ...
  <div>
    ...
    <el-row class="jm-grid-border-1px">
      ...
      <div class="auth-user-botton-group">
        <el-button size="small" :type="primary0" @click="loadAuthUserOverview(0)">浏览量</el-button>
        <el-button size="small" :type="primary1" @click="loadAuthUserOverview(1)">独立访客</el-button>
...
export default {
  ...
  mounted() {
    ...
    //vm.loadthreeCertTotalPieChart();

    //vm.loadcertAuditChart();

    // vm.loadingthreeInOnePieChart = true
    // todo: 
    // pageVisit({
    //   platform,
    //   startDate,
    ...
    //   //  vm.loadingthreeInOnePieChart = false
    //   var chartData = response.data
