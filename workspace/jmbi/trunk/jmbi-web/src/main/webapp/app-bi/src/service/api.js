...
export function shopReleaseRank({
  ...
  let url = `/biservice/v1/shop/releaseRank/${startDate}/${endDate}`
  return fetch(url)
}
...
export function shopDealRank({
  ...
  let url = `/biservice/v1/shop/dealRank/${startDate}/${endDate}`
  return fetch(url)
}
...
// 运营总览
export function operateTotal() {
  // biservice/v1/operate/total
  let url = 'biservice/v1/operate/total'
  return fetch(url)
}
...
export function operateIndex({
  ...
  let url = `/biservice/v1/operate/getBasic/${startDate}/${endDate}`
  return fetch(url)
}
...
export function getBuyerRate({
  ...
  let url = `/biservice/v1/operate/getBuyer/${startDate}/${endDate}`
  return fetch(url)
}
// 运营总览 卖家转化率统计图
export function getSellerRate({
  ...
  let url = `/biservice/v1/operate/getSeller/${startDate}/${endDate}`
  return fetch(url)
}
// 运营总览订单类型
...
//地域金额
// /biservice/v1/deal/areaAmount/seller/20170401/20170428/100700/
export function dealAreaAmount({
  ...
  let url = `/biservice/v1/deal/areaAmount/${startDate}/${endDate}/${platform}`
  return fetch(url)
}
