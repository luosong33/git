...
public class ShopAnalysisSvcImpl extends BaseDataExtract implements IShopAnalysisSvc {
	...
	//设置环境参数
	private void setCustomContext(String platform, String startDate, String endDate,String storeId,
    	...
    	super.setContext(param, trasList, transPlatIdFlag, sql, seriesName, returnSeriesType, returnItemIdType);
	}
	@Override  
    public Response getTopGoodsCategories(String platform, String startDate, String endDate) throws Exception{
    	...
    	this.setCustomContext(platform, startDate, endDate, null, false, sql, "店铺公司名", null,null);
    	baseChartBuilder = SpringContextUtil.getBean("barChartBuilder");
    	return super.extractDataAndBuildChart(baseDaoCallback,baseChartBuilder);
    }
    @Override
    public Response getGoodsIndustryRatio(String platform, String startDate, String endDate, String itemId) throws Exception{
    	...
    	this.setCustomContext(platform, startDate, endDate, itemId, true, sql, null, Long.class,null);
	...
	public Response getMoneyIndustryRatio(String platform, String startDate,
    	...
    	this.setCustomContext(platform, startDate, endDate, itemId, true, sql, null, BigDecimal.class,null);
    	baseChartBuilder = SpringContextUtil.getBean("pieChartBuilder");
    	return super.extractDataAndBuildChart(baseDaoCallback,baseChartBuilder);
	}
