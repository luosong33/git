 ...
 * @version 1.4.0
 */
public class RegMapUtils {

	/**
	 */
	public static <K, V> void fill_key_setMap(Map<K, Set<V>> keySetMap, K key, V val) {
	...
	/**
	 */
	public static <K, V> void fill_key_hashSetMap(Map<K, HashSet<V>> keySetMap, K key, V val) {
	...
	public static <K1, K2, V> void fill_key1_key2_valMap(Map<K1, Map<K2, V>> key1Key2ValMap,
	 ...
	 */
	public static <K> void fill_key_longMapAddUpVal(Map<K, Long> keyLongMap, K key, long val) {
	...
	/**
	 */
	public static void fill_str_strMapAddUpVal(Map<String, String> strStrMap, String key, String val) {
	...
	/**
	 */
	public static <K1, K2, V> void fill_key1_key2_valSetMap(Map<K1, Map<K2, Set<V>>> k1k2ValSetMap,
	...
	/**
	 */
	public static <K1, K2, V> void fill_key1_key2_valListMap(Map<K1, Map<K2, List<V>>> k1k2ValListMap,
			K1 outKey, K2 innerKey, V val) {
	...
	/**
	 */
	public static void fill_str_str_strStrMap(Map<String, Map<String, Map<String, String>>> k1k2k3ValMap,
