...
import org.jumao.bi.utis.constants.Url;
...
public interface RegisterAnalysis {
	 ...
	 */
	@GET
	@Path(Url.REG_NEWLYINCR_LINECHART)
	 ...
	 */
	@GET
	@Path(Url.REG_NEWLYINCR_PIECHART)
	 ...
	 */
	@GET
	@Path(Url.AUTH_U_OVERVIEW_LINECHART)
	 ...
	 */
	@GET
	@Path(Url.AUTH_U_PASSED_HISTOGRAM)
	 ...
	 */
	@GET
	@Path(Url.AUTH_U_AREA_DIST_TOP10)
	 ...
	 */
	@GET
	@Path(Url.VISA_AND_PAY_OVERVIEW_LINECHART)
	...
	/**
	 * 签章支付 历史累计 饼图（缺少相关数据，先放着）
	 */
	@GET
	@Path(Url.VISA_AND_PAY_HISTORY_PIE)
	 ...
	 */
	@GET
	@Path(Url.VISA_AND_PAY_AREA_DIST)
