...
//    	trasList.add("endDate");
		// 原型模式每次获取的是新对象
		context = SpringContextUtil.getBean(ComponentContext.class);
		response = SpringContextUtil.getBean(BaseResponse.class);
	...
	public  Response extractDataAndBuildChart(BaseDaoCallback callBack,
			BaseChartBuilder baseChartBuilder) throws Exception {
